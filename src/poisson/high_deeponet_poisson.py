...
def main(args):
    ...
    if args.mode == "train":
        ...
        model.save("high_poisson")
    elif args.mode == "test":
        model.restore(f"high_poisson-{epochs}.pt")
        ...
        # plt.show()
        plt.savefig("high_poisson.png")
        np.savez_compressed("high_poisson.npz", x=x, y=y, fx=fx, mae=mae)
        import pdb; pdb.set_trace()
